...
var CraftSkeletonGenerator = yeoman.generators.Base.extend({
  ...
  app: function () {
    ...
    //  --------------------------------------------------------
    this.copy('_main.html', 'templates/_layout/_main.html');
    this.copy('_head.html', 'templates/_partials/_head.html');

    this.copy('_404.html', 'templates/404.html');
    this.copy('_cs.html', 'templates/cs.html');
    this.copy('_index.html', 'templates/index.html');
  },
